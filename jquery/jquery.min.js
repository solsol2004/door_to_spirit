          ...
          null != (a = e.LogoBg) && "" != a
            ...
            null != (t = e.NavbarBg) && "" != t
              ? ($("#" + i + " .topbar .navbar-collapse").attr(
                ...
                $("#" + i + " .topbar").attr("data-navbarbg", t),
                $("#" + i).attr("data-navbarbg", t))
              : ($("#" + i + " .topbar .navbar-collapse").attr(
                  "data-navbarbg",
                  "skin1"
                ),
  ...
  $(function () {
    ...
    $("#chat .message-center a").on("click", function () {
      var a = $(this).find(".mail-contnet h5").text(),
        t = $(this).find(".user-img img").attr("src"),
        e = $(this).attr("data-user-id"),
        i = $(this).find(".profile-status").attr("data-status");
      if ($(this).hasClass("active"))
        $(this).toggleClass("active"), $(".chat-windows #user-chat" + e).hide();
      else if (
        ($(this).toggleClass("active"),
        $(".chat-windows #user-chat" + e).length)
      )
        $(".chat-windows #user-chat" + e)
      ...
      $(document).on(
        ...
        function (a) {
          var t = $(this).attr("data-user-id");
          $(".chat-windows #user-chat" + t).hasClass("mini-chat")
            ? $(".chat-windows #user-chat" + t).removeClass("mini-chat")
            : $(".chat-windows #user-chat" + t).addClass("mini-chat");
        }
      ),
      $(document).on(
        "keypress",
        ...
        function (a) {
          if (13 == a.keyCode) {
            ...
            (e = msg_sent(e)),
              $(
                ".chat-windows #user-chat" + t + " .chat-body .chat-list"
              ).append(e),
              $(this).val(""),
              $(this).focus();
          }
          $(".chat-windows #user-chat" + t + " .chat-body").perfectScrollbar({
            suppressScrollX: !0,
          });
        }
      ),
