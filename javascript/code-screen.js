const codeBtn = document.getElementById("code-enter");
const nameBtn = document.getElementById("name-enter");
...
codeBtn.addEventListener("click", firstPage);
nameBtn.addEventListener("click", secondPage);
